  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-slate-950">
      ...
      <img
        ...
        alt="Shanghai Proton Heavy Ion Hospital exterior"
        ...
        <div>
          ...
          <div className="flex flex-wrap justify-center gap-4 mb-8">
            <span className="px-4 py-2 bg-white/10 rounded-full text-sm">
              China&apos;s first hospital offering both proton and heavy ion
              therapy
            </span>
            <span className="px-4 py-2 bg-white/10 rounded-full text-sm">
              9,317 total patients treated
            </span>
            <span className="px-4 py-2 bg-white/10 rounded-full text-sm">
              50+ treatable diseases
            </span>
          </div>
