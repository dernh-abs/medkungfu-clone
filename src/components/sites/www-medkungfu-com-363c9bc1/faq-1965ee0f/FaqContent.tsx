...
// including its bilingual (EN/zh) content: hero, sidebar label, notice boxes,
// and all 72 Q&A switch to Chinese when the site language is zh.
            ...
            <div className="bg-white border border-gray-100 rounded-xl p-5 md:p-6 shadow-sm">
              <div className="flex items-start gap-3">
                ...
                <p className="text-sm md:text-base text-gray-700 leading-relaxed">
                  {zh ? MEDICAL_NOTICE_ZH : MEDICAL_NOTICE_EN}
                </p>
              </div>
            </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h2 className="text-sm font-semibold text-[#1A1A2E] mb-2">
                    {zh ? "实体与合同说明" : "Entity and Contract Note"}
                  </h2>
                  <p className="text-sm md:text-base text-gray-700 leading-relaxed">
                    {zh ? ENTITY_NOTE_ZH : ENTITY_NOTE_EN}
                  </p>
                </div>
              </div>
            </div>
                  ...
                  >
                    ...
                    >
                      ...
                      <span className="flex-1 font-semibold text-[#1A1A2E] leading-relaxed">
                        {zh ? item.questionZh : item.question}
                      </span>
                      <Icons.chevronDown
