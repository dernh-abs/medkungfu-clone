  ...
  components: {
    ...
    pageSection: {
      ...
      fields: {
        ...
        titleZh: { type: "text", label: "标题(中)" },
        body: { type: "textarea", label: "正文" },
        bodyZh: { type: "textarea", label: "正文(中)" },
        ...
        linkLabelZh: { type: "text", label: "链接文字(中)" },
        ...
        features: {
          ...
          defaultItemProps: { title: "", titleZh: "", body: "", bodyZh: "" },
        },
        stats: {
          type: "array",
          label: "数据条（数值+标签）",
          arrayFields: {
            ...
            labelZh: { type: "text", label: "标签(中)" },
          },
          defaultItemProps: { value: "", label: "", labelZh: "" },
        },
      },
      defaultProps: {
        kind: "content",
