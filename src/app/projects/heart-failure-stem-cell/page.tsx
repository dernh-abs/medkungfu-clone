...
import { heartFailureRu } from "@/components/sites/www-medkungfu-com-363c9bc1/projects-detail/stem-cell/heartFailureRu";
  ...
  return (
    <>
      ...
      <main className="flex-grow pt-[72px]">
        <StemCellDetailPage data={heartFailure} zhConfig={heartFailureZh} ruConfig={heartFailureRu} />
      </main>
      <SiteFooter />
    </>
  );
