...
const CONFIG_RU: ImmunotherapyProjectConfig = {
  ...
  hero: {
    ...
    title: "Китайская боронейтронная пленочная терапия (BNCT)",
    subtitle: "Precise “Cell Knife”, Reshaping Refractory Tumor Treatment Landscape",
  ...
  intro: {
    heading: "Что такое BNCT?",
    paragraphs: [
      {
        before:
          "Boron Neutron Capture Therapy (BNCT) is a revolutionary precision targeted radiotherapy technology. Due to its particle killing range being only at the cellular scale, BNCT is called ",
        highlight: "«Костюмный нож»",
        after:
          "Обладая уникальными преимуществами точного таргетинга, высокой относительной биологической эффективностью и клиническим облучением, как правило, требуется только один-два сеанса для завершения курса.",
      },
      {
        before:
          "BNCT позиционируется как важный метод лечения опухолей после операции, лучевой терапии, химиотерапии и иммунотерапии, демонстрируя значительную клиническую ценность во всем мире.",
      },
    ],
  },
  advantages: {
    heading: "Почему стоит выбрать BNCT в Китае?",
    bg: "bg-white",
    items: [
      {
        icon: "globe",
        title: "Глобальный прогресс в области клинического одобрения",
        description:
          "Китай является второй страной в мире с официально утвержденными клиническими лечебными учреждениями BNCT.",
      },
      {
        icon: "clock",
        title: "Чрезвычайно короткий курс лечения, низкая доза облучения",
        description:
          "BNCT's unique “Cell Knife” characteristic, clinical irradiation usually requires only 1-2 sessions to complete the course, treatment time 30-50 minutes, no repeated hospitalization needed, patients experience easy and painless treatment",
      },
      {
        icon: "target",
        title: "Точная мишень, минимальные побочные эффекты",
        description:
          "BNCT вызывает минимальное повреждение окружающих нормальных тканей, отсутствие выраженной нейротоксичности или системной токсичности, превосходит традиционную лучевую терапию и системную химиотерапию, значительно улучшая качество жизни пациентов.",
      },
      {
        icon: "trendingUp",
        title: "Отличная эффективность, переписывание правил лечения рефрактерного рака",
        description:
          "Зарубежные реальные данные показывают: рак головы и шеи ORR 80,5%, уровень CR ангиосаркомы 50% (данные ESMO 2025), менингиома BNCT группа лечения 2-летняя выживаемость 90,9%",
      },
      {
        icon: "zap",
        title: "Пионер политики, глобальная интеграция",
        description:
          "Leveraging Hainan Boao Lecheng “Pilot First” policy, international cutting-edge BNCT technology introduced synchronously with priority access, no need to wait for lengthy approvals",
      },
    ],
  ...
  indications: {
    heading: "Показания",
    intro:
      "BNCT особенно подходит для пациентов с опухолями, не реагирующих на обычную химиорадиотерапию, с рецидивирующими / тугоплавкими состояниями или расположенными в важных функциональных областях.",
    listItems: [
      "Злокачественные опухоли головы и шеи (включая носоглоточную карциному, рак полости рта, рак гортани, рак языка, рак десны, рак паротидной железы и более десяти подтипов)",
      "Высокосортная глиома (ГБМ, включая недавно диагностированную и рецидивирующую)",
      "Злокачественная менингиома (рецидивирующая)",
    ],
    sideCard: {
      heading: "Подходящие пациенты",
      bullets: [
        "Пациенты с локально развитыми опухолями, не реагирующими на обычную хирургию / радиотерапию или с рецидивом",
        "Пациенты, устойчивые к традиционной химиорадиотерапии и неоперабельные",
        "Педиатрические опухоли (значительно снижающие влияние на рост и развитие)",
        "Пациенты с рецидивирующими высококачественными опухолями головного мозга",
      ],
      note: "Примечание: Подходит ли лечение BNCT для лечения, требует комплексной индивидуальной оценки многопрофильной группой экспертов.",
    },
  },
  treatmentContent: {
    heading: "Содержание лечения",
    subtitle: "Лечение BNCT обычно включает следующие ключевые этапы:",
    bg: "bg-white",
    items: [
      {
        title: "Многопрофильная оценка команды и скрининг",
        description:
          "Команда MDT, состоящая из экспертов по онкологии, физиков-радиологов, специалистов по ядерной медицине, всесторонне оценивает характеристики опухоли пациента и пригодность лечения.",
      },
      {
        title: "18F-BPA PET Оценка изображений",
        description:
          "Благодаря ведущей в мире технологии визуализации борных лекарственных средств, точно оценивает биологическое распределение и концентрацию борсодержащих препаратов в опухолях.",
      },
      {
        title: "Персонализированный дизайн плана лечения",
        description:
          "На основе 3D-морфологии опухоли пациента, данных о распределении борных препаратов и рисках для органов, используется специализированная система планирования лечения для разработки персонализированных планов облучения.",
      },
      {
        title: "Борсодержащий препарат Внутривенная инъекция",
        description:
          "Пациенты получают внутривенное введение целенаправленных боросодержащих препаратов за несколько часов до облучения, препараты избирательно накапливаются в опухолевых клетках",
      },
      {
        title: "Облучение нейтронным лучом",
        description:
          "В день лечения пациенты получают облучение нейтронным лучом на лечебном ложе. Лечение безболезненно, пациенты могут слушать музыку или общаться в течение 30-50 минут.",
      },
      {
        title: "Мониторинг и поддержка больниц",
        description:
          "После завершения облучения врачи внимательно следят за состоянием пациента. Большинству пациентов требуется всего 1-2 облучения, пребывание в стационаре значительно короче, чем при традиционной лучевой терапии.",
      },
    ],
  },
  process: {
    ...
    steps: [
      {
        ...
        duration: "2-5 дней",
        description:
          "Отправка медицинских карт, междисциплинарная экспертная группа дистанционно оценивает критерии индикации BNCT",
      },
      {
      ...
      {
        title: "Прибытие в Китай и оценка экзаменов",
        duration: "2-3 дня",
        description:
          "Комплексная физическая оценка, 18F-BPA PET-КТ, определение объема цели, обзор плана лечения",
      },
      {
        title: "Облучение BNCT",
        duration: "1-2 сеанса, по 30-50 минут каждый",
        description:
          "Боросодержащий препарат инъекция + нейтронный пучковый облучение лечение, безболезненное, неинвазивное, не требуется хирургическое вмешательство",
      },
      {
        title: "Краткосрочный мониторинг больниц",
        duration: "3-7 дней",
        description: "Тесный мониторинг побочных реакций, реабилитационная поддержка",
      },
      {
        title: "Вывод и долгосрочное наблюдение",
        duration: "Вперед",
        description: "Регулярное повторное обследование, дистанционное последующее управление",
      },
    ],
    summaryNote: {
      before:
      ...
      after: ", с очень коротким циклом лечения.",
    },
  },
  efficacy: {
    heading: "Данные об эффективности",
    subtitle: "Зарубежные клинические данные (данные о страховании в реальном мире Японии, для справки)",
    bg: "bg-white",
    table: {
      wrapClassName: "-mx-4 overflow-x-auto px-4 sm:mx-0 sm:px-0",
      tableClassName: "w-full min-w-[680px] bg-white rounded-2xl shadow-sm overflow-hidden",
      headers: ["указание", "Тип исследования", "показатель", "Данные"],
      rows: [
        {
          bg: "bg-white",
          cells: [
            { text: "Местно-распространенный / рецидивирующий неоперабельный рак головы и шеи", className: "px-6 py-4 text-gray-700" },
            { text: "Исследование реального мира (69 случаев)", className: "px-6 py-4 text-gray-600 text-sm" },
            { text: "Коэффициент объективного ответа (ORR)", className: "px-6 py-4 text-gray-700" },
            { text: "80.5%", className: "px-6 py-4 text-[#1B4D3E] font-semibold" },
          ],
        },
        {
          bg: "bg-[#F5F7FA]",
          cells: [
            { text: "Как и выше", className: "px-6 py-4 text-gray-700" },
            { text: "Исследование реального мира", className: "px-6 py-4 text-gray-600 text-sm" },
            { text: "1-летний общий показатель выживаемости", className: "px-6 py-4 text-gray-700" },
            { text: "75.4%", className: "px-6 py-4 text-[#1B4D3E] font-semibold" },
          ],
        },
        {
          bg: "bg-white",
          cells: [
            { text: "Ангиосаркома (редкое злокачественное образование кожи)", className: "px-6 py-4 text-gray-700" },
            { text: "II фаза клинических испытаний (ESMO 2025)", className: "px-6 py-4 text-gray-600 text-sm" },
            { text: "Полный ответ на вопрос", className: "px-6 py-4 text-gray-700" },
            { text: "50%", className: "px-6 py-4 text-[#1B4D3E] font-semibold" },
          ],
        },
        {
          bg: "bg-[#F5F7FA]",
          cells: [
            { text: "Рецидивирующая высококлассная менингиома", className: "px-6 py-4 text-gray-700" },
            { text: "II фаза рандомизированного контролируемого испытания", className: "px-6 py-4 text-gray-600 text-sm" },
            { text: "Прогрессивное выживание", className: "px-6 py-4 text-gray-700" },
            { text: "BNCT Group: 14,4 месяца против Control Group: всего 1,4 месяца", className: "px-6 py-4 text-[#1B4D3E] font-semibold" },
          ],
        },
        {
          bg: "bg-white",
          cells: [
            { text: "Рецидивирующая высококлассная менингиома", className: "px-6 py-4 text-gray-700" },
            { text: "II фаза рандомизированного контролируемого испытания", className: "px-6 py-4 text-gray-600 text-sm" },
            { text: "2-летняя выживаемость", className: "px-6 py-4 text-gray-700" },
            { text: "Группа лечения BNCT: 90,9%", className: "px-6 py-4 text-[#1B4D3E] font-semibold" },
          ],
        },
      ],
    },
    footnote:
      "Источники данных: Конференция ESMO по раковой медицине 2024, 2025, Испытание II фазы Медицинского и фармацевтического университета Осаки",
  },
  cases: {
    heading: "Тематические исследования",
    items: [
      {
        title: "Рецидивирующий пациент с карциномой носоглотки",
        description:
          "Китайский пациент с рецидивирующей носоглоточной карциномой в возрасте до 40 лет был диагностирован в 2016 году и получил радикальную химиорадиотерапию. После рецидива заболевания в 2024 году было проведено иммунотерапевтическое вмешательство, но в 2025 году оно снова прогрессировало, а обычные методы лечения оказались неэффективными. В августе 2025 года он получил лечение в рамках клинического испытания BNCT. В течение 3-4 дней после лечения первоначальные симптомы были значительно облегчены. Восемь месяцев спустя результаты визуализации МРТ и PET-КТ были обнадеживающими: показатели метаболизма опухоли упали ниже диагностических стандартов, эффективность оценивалась как полный ответ (CR), и пациент успешно вернулся к нормальной работе и жизни.",
      },
      {
        title: "Многоцентровые клинические испытания BNCT",
        description:
          "В BNCT В ходе клинических испытаний I фазы у более зарегистрированных пациентов наблюдалось хорошее клиническое улучшение: значительно улучшились боль в лице и онемение губ у пациента с опухолью головы и шеи; эффективно контролировалось кровотечение и отек левой щеки пациента с раком полости рта; улучшился слух правого уха пациента с опухолью черепа-гиганта, а зрение стало более ясным.",
      },
      {
        title: "BNCT – первое успешное лечение редкой хондросаркомы",
        description:
          "A 31-year-old male was diagnosed with rare mesenchymal chondrosarcoma in 2018, experienced local recurrence in 2021, refused secondary surgery due to concerns about facial disfigurement and functional impairment, and subsequent anti-PD-1 monoclonal antibody treatment was ineffective. The patient received AB-BNCT system “Jifengdao” and boron-containing drug treatment in 2022. Tumor-induced bleeding stopped within 24 hours after first treatment, ulcer surface significantly reduced within one week. Tumor volume significantly decreased after two irradiations, with efficacy and safety validated by international authoritative journals.",
      },
    ],
  ...
  cost: {
    ...
    intro:
      "Стоимость лечения BNCT имеет значительные преимущества по сравнению с другими передовыми методами лучевой терапии (протонная/тяжелая ионная терапия).",
    label: "Исходя из состояния пациента, стоимость лечения одного курса составляет приблизительно",
    amount: "$43,000 - $72,000",
    bg: "bg-white",
  },
  whyChooseUs: {
    ...
    items: [
      {
        icon: "stethoscope",
        title: "Прямой доступ к лучшим китайским центрам BNCT",
        description: "Установленные партнерские отношения с несколькими учреждениями высшего уровня",
      },
      {
        icon: "globe",
        title: "Глобальный прогресс в области клинического одобрения",
      ...
      {
        icon: "trendingUp",
        title: "Значительная эффективность, твердые данные",
        description:
          "BNCT рак головы и шеи в реальном мире ORR 80,5%, Китай IIT клиническое исследование ORR 71% (90 дней)",
      },
      {
        icon: "shield",
      ...
      {
        icon: "clock",
        title: "Эффективное планирование, быстрый прием",
        description:
          "Завершено в течение 2-4 недель, избегая периодов ожидания, когда западные технологии еще не получили широкого распространения.",
      },
      {
        icon: "users",
  ...
  notice: {
    text:
      "Терапия BNCT имеет значительную эффективность, но не подходит для всех пациентов с опухолями. Эффекты лечения различаются в зависимости от индивидуальных различий, все пациенты должны пройти комплексную медицинскую оценку перед лечением и подписать информированное согласие. В настоящее время BNCT в основном предназначен для групп населения с рецидивами, тугоплавкими состояниями или ограниченными стандартными вариантами лечения. Подходит ли лечение BNCT для лечения, требует строгой, индивидуальной оценки со стороны многопрофильной группы экспертов.",
    bg: "bg-white",
  },
  cta: {
    heading: "Начните свой курс лечения BNCT",
    subtitle:
      "Свяжитесь с нашей профессиональной командой для персонализированной оценки и планирования лечения BNCT",
