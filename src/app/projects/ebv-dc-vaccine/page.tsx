...
const CONFIG_RU: ImmunotherapyProjectConfig = {
  ariaLabel: "EBV-Related DC Vaccine Therapy",
  hero: {
    badge: "Точная онкология",
    title: "Вакцинная терапия DC для связанных с EBV гематологических опухолей",
    subtitle: "Пробуждение аутоиммунитета, точно устранение гематологических опухолей, управляемых EBV",
    primaryBtn: "Записаться на консультацию",
  ...
  intro: {
    heading: "Что такое вакцинная терапия DC, связанная с EBV?",
    paragraphs: [
      {
        before:
          "Epstein-Barr Virus (EBV) is the first confirmed human tumor-related virus worldwide, with approximately ",
        highlight: "200 000 случаев рака",
        after: " caused by EBV infection annually.",
      },
      {
        before: "",
      ...
      {
        before:
          "KSD-101 является первым китайским оригинальным продуктом вакцины против дендритных клеток (DC), получившим одобрение FDA IND и FDA Fast Track Designation (FTD). В 2026 году продукт получил обозначение FDA Regenerative Medicine Advanced Therapy (RMAT) для лечения рецидивирующей или тугоплавкой EBV-положительной лимфомы.",
      },
    ],
  },
  advantages: {
    heading: "Основные преимущества: Почему стоит выбрать вакцинотерапию в Китае?",
    bg: "bg-white",
    items: [
      {
        icon: "globe",
        title: "Первая в мире технология, двойное одобрение Китая и США",
        description:
          "KSD-101 является первой в мире широкоспектральной вакциной EBV, одновременно одобренной Китайской национальной поликлиникой для клинических испытаний и US FDA IND, с обозначениями FTD и RMAT, ведущей международной признанием.",
      },
      {
        icon: "trendingUp",
        title: "Прорывная клиническая эффективность",
        description:
          "Данные клинических исследований показывают ORR до 91,67%, CR 83,33%, DCR 100%, замечательную эффективность.",
      },
      {
        icon: "shield",
        title: "Отличный профиль безопасности",
        description:
          "Побочные реакции в основном умеренные (реакции места инъекции, лихорадка, увеличение лимфатических узлов), все 1-2 степени, нет ≥ 3 степени токсичности или дозоограничивающей токсичности (DLT).",
      },
      {
        icon: "syringe",
        title: "Удобное управление, отсутствие истощения лимфоцитов",
        description:
          "Подкожная инъекция каждые 2 недели, 3-5 сеансов, хорошая переносимость и соблюдение пациентом; отсутствие необходимости в предварительном лечении истощения лимфоцитов или профилактических препаратах, упрощенный процесс лечения",
      },
      {
        icon: "target",
        title: "Устранение ограничений HLA, широкое применение",
        description:
          "Прорывы через ограничения традиционной иммунотерапии в HLA-совпадении и узком спектре антигенов, эффективно представляет несколько вирусных эпитопов, включая LMP2 и EBNA1, значительно расширяя диапазон иммунной распознавания",
      },
      {
        icon: "zap",
        title: "Двойные терапевтические эффекты",
        description:
          "Одновременно оказывает двойное противовирусное и противоопухолевое терапевтическое действие, очищая инфицированные вирусом опухолевые клетки при восстановлении устойчивой иммунной памяти для предотвращения рецидива.",
      },
      {
        icon: "mapPin",
        title: "Пилотная зона Хайнань Боао",
        description:
          "Leveraging Lecheng “Pilot First” policy, KSD-101 has been implemented at Ruijin Hospital Hainan Branch, providing eligible patients with this globally leading treatment technology",
      },
    ],
  ...
  indications: {
    heading: "Показания",
    intro:
      "KSD-101 в основном подходит для пациентов с гематологической опухолью, связанных с EBV, у которых не было стандартного лечения или рецидив. Подтипы, которые в настоящее время подтверждены клиническими исследованиями, включают:",
    listItems: [
      "EBV-положительная диффузная большая лимфома B-клеток (EBV + DLBCL)",
      "EBV-ассоциированная лимфома NK/T-клеток (NKTCL, носовой/периферический тип)",
      "Лимфома Ходжкина (HL, EBV-позитивный)",
      "Ангиоиммунобластическая Т-клеточная лимфома (AITL)",
      "Хроническая активная инфекция EBV (CAEBV)",
      "EBV-ассоциированный гемофагоцитарный лимфогистиоцитоз (EBV-HLH)",
      "EBV-положительная нодальная Т-фолликулярная лимфома клетки-помощника (тип NTFHL-AI)",
      "Лимфома Беркитта (BL, EBV-позитивная)",
    ],
    sideCard: {
      heading: "Примечания по оценке",
      description:
        "Подходит ли вакцина для лечения DC, требует комплексной индивидуальной оценки многопрофильной экспертной группы. Исследования показывают, что пациенты с плохой толерантностью к традиционной химиотерапии могут извлечь больше пользы.",
      listHeading: "Особенности лечения",
      features: [
        "Аутологичная клеточная терапия, высокая безопасность",
        "Не требуется предварительная обработка истощения лимфоцитов",
        "Подкожная инъекция, проста в эксплуатации",
        "Последующие инъекции могут быть завершены амбулаторно",
      ],
    },
  },
  treatmentContent: {
    heading: "Содержание лечения",
    subtitle: "Вакцинная терапия DC включает следующие основные компоненты:",
    bg: "bg-white",
    items: [
      {
        title: "Многопрофильная оценка команды и скрининг",
        description:
          "Команда МДТ, состоящая из экспертов в области гематологии-онкологии, экспертов в области иммунологии и т.д., всесторонне оценивает состояние инфекции EBV, характеристики опухоли и показания к лечению.",
      },
      {
        title: "Коллекция моноцитов",
        description:
          "Собрать достаточное количество моноцитов из периферической крови пациента через лейкаферез, отправить в сертифицированную GMP лабораторию для последующего приготовления",
      },
      {
        title: "Персонализированная подготовка DC-вакцины",
        description:
          "В сертифицированной GMP лаборатории собранные моноциты индуцируются для дифференциации в дендритные клетки in vitro и загружаются с EBV-специфическими композитными антигенами для приготовления персонализированных терапевтических вакцин.",
      },
      {
        title: "DC вакцина подкожная инъекция",
        description:
          "Готовая вакцина возвращается в организм пациента через подкожную инъекцию, внимательно наблюдают реакции после каждой инъекции. Никакого истощения лимфоцитов предварительной обработки или профилактических лекарств, необходимых на протяжении всего процесса.",
      },
      {
        title: "Регулярное наблюдение и иммунный мониторинг",
        description:
          "Регулярное наблюдение после лечения, мониторинг уровня ДНК EBV и иммунного ответа, оценка эффективности и безопасности",
      },
    ],
  },
  process: {
    heading: "Процесс лечения",
    subtitle: "Примерно 2-3 месяца от первоначальной консультации до выздоровления",
    steps: [
      {
        title: "Дистанционное консультирование и первоначальный скрининг",
        duration: "2-5 дней",
        description:
          "Предоставить медицинские записи для дистанционной оценки многопрофильной группой экспертов для определения права на вакцинотерапию DC.",
      },
      {
        title: "Визовые и туристические соглашения",
        duration: "1-2 недели",
        description:
          "Приглашение на медицинскую визу, международная координация страхования, планирование маршрута и размещение",
      },
      {
        title: "Прибытие в Китай и всесторонняя оценка",
        duration: "2-3 дня",
        description:
          "Комплексное физическое обследование, ДНК-тестирование EBV, оценка иммунологической функции, оценка бремени опухоли",
      },
      {
        title: "Коллекция моноцитов",
        duration: "1 день",
        description: "Собрать моноциты периферической крови пациента через лейкаферез",
      },
      {
        title: "DC Подготовка вакцины",
        duration: "2-3 недели",
        description:
          "Введение дифференцировки дендритных клеток и нагрузка антигенов EBV в лаборатории GMP",
      },
      {
        title: "Подкожное инъекционное лечение",
        duration: "6-10 недель",
        description: "Подкожная инъекция каждые 2 недели, 3-5 сеансов",
      },
      {
        title: "Мониторинг госпитализации и выписка",
        duration: "3-7 дней (после первой инъекции)",
        description:
          "Краткосрочная госпитализация для тщательного наблюдения после первой инъекции, последующие инъекции могут быть завершены амбулаторно",
      },
      {
        title: "Долгосрочное последующее управление",
        duration: "Вперед",
        description:
          "Регулярные последующие обследования, удаленные консультации, мониторинг иммунного ответа",
      },
    ],
    summaryNote: {
      before:
        "From arrival in China to completion of all injection treatments, the entire process typically takes ",
      highlight: "8-12 недель",
      after:
        "Более короткий цикл и более высокое удобство по сравнению с традиционной лучевой терапией и химиотерапией.",
    },
  },
  efficacy: {
    heading: "Данные об эффективности",
    subtitle: "Обзор основных данных по эффективности (последние данные, опубликованные EHA 2025)",
    bg: "bg-white",
    stats: [
      {
        label: "Коэффициент объективного ответа (ORR)",
        value: "91.67%",
        note: "Многолинейные рецидивирующие/рефрактерные пациенты с гематологической опухолью, связанные с EBV",
      },
      {
        label: "Полный уровень ответа (CR)",
        value: "83.33%",
        note: "Многолинейные рецидивирующие/рефрактерные пациенты с гематологической опухолью, связанные с EBV",
      },
      {
        label: "Уровень контроля заболеваний (DCR)",
        value: "100%",
        note: "Многолинейные рецидивирующие/рефрактерные пациенты с гематологической опухолью, связанные с EBV",
      },
      {
        label: "Медиана последующих действий",
        value: "42.7周",
        note: "Большинство пациентов достигли и поддерживали полный ответ (CR).",
      },
    ],
    safetyHeading: "Данные о безопасности",
    table: {
      headers: ["Побочный тип реакции", "Уровень заболеваемости", "тяжелая"],
      rows: [
        {
          bg: "bg-white",
          cells: [
            { text: "Реакции сайта инъекций", className: "px-6 py-4 text-gray-700" },
            { text: "~91%", className: "px-6 py-4 text-[#1B4D3E] font-semibold" },
            { text: "1 класс, мягкий", className: "px-6 py-4 text-gray-600" },
          ],
        },
        {
          bg: "bg-[#F5F7FA]",
          cells: [
            { text: "лихорадка", className: "px-6 py-4 text-gray-700" },
            { text: "Может произойти", className: "px-6 py-4 text-[#1B4D3E] font-semibold" },
            { text: "2 класс, умеренный", className: "px-6 py-4 text-gray-600" },
          ],
        },
        {
          bg: "bg-white",
          cells: [
            { text: "Расширение лимфатических узлов", className: "px-6 py-4 text-gray-700" },
            { text: "Может произойти", className: "px-6 py-4 text-[#1B4D3E] font-semibold" },
            { text: "1 класс, мягкий", className: "px-6 py-4 text-gray-600" },
          ],
        },
        {
          bg: "bg-[#F5F7FA]",
          cells: [
            { text: "3 класс токсичности", className: "px-6 py-4 text-gray-700" },
            { text: "0%", className: "px-6 py-4 text-[#1B4D3E] font-semibold" },
            { text: "Не наблюдалось", className: "px-6 py-4 text-gray-600" },
          ],
        },
        {
          bg: "bg-white",
          cells: [
            { text: "Токсичность, ограничивающая дозу (DLT)", className: "px-6 py-4 text-gray-700" },
            { text: "0%", className: "px-6 py-4 text-[#1B4D3E] font-semibold" },
            { text: "Не наблюдалось", className: "px-6 py-4 text-gray-600" },
          ],
        },
  ...
  cost: {
    heading: "Стоимость справочного лечения",
    label: "Общая стоимость лечения приблизительно",
    amount: "$110,000 - $150,000",
  },
  whyChooseUs: {
    ...
    items: [
      {
        icon: "stethoscope",
        title: "Прямой доступ к ведущим центрам вакцин DC в Китае",
        description:
          "Сотрудничество с несколькими ведущими учреждениями для предоставления безопасных и надежных услуг по вакцинотерапии DC.",
      },
      {
        icon: "globe",
        title: "Первая в мире китайская оригинальная технология",
        description:
          "KSD-101 является первой в мире широкоспектральной вакциной EBV, одобренной как Китаем, так и США, с обозначениями FDA FTD и RMAT.",
      },
      {
        icon: "trendingUp",
        title: "Ведущие международные данные эффективности",
        description:
          "ORR 91.67%, CR 83.33%, DCR 100%, отличные показатели при рецидивирующих/рефрактерных гематологических опухолях, связанных с EBV",
      },
      {
        icon: "shield",
        title: "Безопасность намного выше химиотерапии и CAR-T",
        description:
          "Нежелательные явления, связанные с лечением, являются умеренными, не токсичными 3 степени, не требуется истощение лимфоцитов, отличная толерантность",
      },
      {
        icon: "syringe",
        title: "Удобное управление, амбулаторное возможно",
        description:
          "Подкожная инъекция проста в эксплуатации, последующие инъекции могут быть выполнены без госпитализации, высокая степень соблюдения пациентом требований.",
      },
      {
        icon: "mapPin",
        title: "Политика пилотной зоны Хайнань Боао Леченг",
        description:
          "Enjoy “Pilot First” policy, priority access to international cutting-edge therapies, compliant, safe, efficient",
      },
      {
        ...
        description: "Медицинские сборы, выплачиваемые непосредственно больнице, платформа не обрабатывает и не разметывает",
      },
      {
        icon: "users",
        title: "Полный двуязычный сервис",
        description: "Перевод медицинской документации, устный перевод на месте, поддержка одного окна",
      },
      {
        icon: "heart",
        title: "Долгосрочное последующее управление",
        description:
          "Непрерывное дистанционное наблюдение после лечения, непрерывный иммунный мониторинг",
      },
    ],
  },
  notice: {
    text:
      "Вакцина DC обладает значительной эффективностью, но не подходит для всех пациентов с опухолями. Эффекты лечения различаются в зависимости от индивидуальных различий, и все пациенты должны пройти комплексную медицинскую оценку и подписать информированное согласие до начала лечения. В настоящее время вакцины DC в основном предназначены для пациентов с гематологической опухолью, связанных с EBV, у которых рецидив, рефрактер или плохой ответ на стандартное лечение. Подходит ли лечение для лечения требует строгой, индивидуальной оценки многопрофильной группы экспертов.",
  },
  cta: {
    heading: "Начните свое путешествие по вакцинотерапии DC",
    subtitle:
      "Свяжитесь с нашей профессиональной командой, чтобы получить персонализированную оценку и план лечения вакциной DC.",
    primary: { label: "Записаться на консультацию", href: "/contact" },
    secondary: { label: "WhatsApp Consultation", href: "https://wa.me/16462968491", external: true },
  },
};
